...
export function Categories() {
    ...
    return (
        <Container my="md" className='Categories'>
        <SimpleGrid cols={2} spacing="lg" breakpoints={[{ maxWidth: 'sm', cols: 1 }]}>
            <div height={PRIMARY_COL_HEIGHT}>
                <Image w={'100%'} radius={'md'} src="https://i.scdn.co/image/69b74b20843e6166351057e95221b6b99978549f" alt="" />
                <Container mt={10}>
                    <Title order={3}>Geeky Theory</Title>
                    <Text fs={'italic'} fz={'sm'} fw={100}>Tecnologia</Text>
                    ...
                    el desarrollo de software, la inteligencia artificial y el diseño web.<br/>
                    ...
                    los oyentes informados y actualizados.</Text>
                </Container>
            </div>
            <Grid gutter="md">
            <Grid.Col span={6}>
                <div height={SECONDARY_COL_HEIGHT}>
                    <Image radius={'md'} src="https://i.scdn.co/image/ab67656300005f1f997d66105c826d42ea027261" alt="" />
                    <Container mt={10}>
                        ...
                        ¿Nuestro objetivo? Ayudarte a entenderte mejor.</Text>
                    </Container>
                </div>
            </Grid.Col>
            <Grid.Col span={6}>
                <div height={SECONDARY_COL_HEIGHT}>
                    <Image radius={'md'} src={PODCAST_3} alt="" />
                    <Container mt={10}>
            ...
            <Grid.Col span={6}>
                <div height={SECONDARY_COL_HEIGHT}>
                    <Image radius={'md'} src='https://i.scdn.co/image/ab67656300005f1fb20cd2673b7b412f207c5afd' alt="" />
                    <Container mt={10}>
            ...
            <Grid.Col span={6}>
                <div height={SECONDARY_COL_HEIGHT}>
                    <Image radius={'md'} src='https://i.scdn.co/image/47934c7e49c8b318c052bc661ad68fca8e3b3039' alt="" />
                    <Container mt={10}>
